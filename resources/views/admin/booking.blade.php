...
<head>
    ...
    <title>Booking Admin - Penjualan Motor</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="sidebar-menu">
                    ...
                    <a href="{{ route('admin.booking') }}" class="active">
                                    ...
                                    <tbody>
                                        @foreach ($booking as $b)
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- Dropdown Status -->
                                                    <form action="{{ route('admin.booking.updateStatus', $b->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    <form
                                                                        action="{{ route('admin.booking.destroy', $b->id) }}"
                                                                        method="POST">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="button"

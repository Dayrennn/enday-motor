...
<body>
    ...
    <section class="hero-section" id="home"
        style="background: url('{{ Vite::asset('resources/images/honda.jpg') }}') no-repeat center center; background-size: cover; padding: 120px 0; position: relative;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-6 text-white">
                    <h1 class="display-4 fw-bold mb-4">Honda</h1>
                    <p class="lead mb-4">
                        Motor Honda dikenal irit, tangguh, dan nyaman digunakan sehari-hari. Dibekali teknologi modern
                        dan desain stylish, Honda menjadi pilihan utama karena perawatan mudah dan performa mesin yang
                        terpercaya.
                    </p>

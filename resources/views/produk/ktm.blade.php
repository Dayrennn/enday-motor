...
<body>
    ...
    <section class="hero-section" id="home"
        style="background: url('{{ Vite::asset('resources/images/ktm.jpg') }}') no-repeat center center; background-size: cover; padding: 120px 0; position: relative;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-6 text-white">
                    <h1 class="display-4 fw-bold mb-4">KTM</h1>
                    <p class="lead mb-4">
                        KTM terkenal dengan performa agresif dan karakter mesin yang bertenaga. Dirancang untuk
                        pengendara yang menyukai tantangan, kecepatan, dan handling yang responsif. Cocok untuk mereka
                        yang menginginkan sensasi berkendara ekstrem di jalanan maupun off-road.
                    </p>

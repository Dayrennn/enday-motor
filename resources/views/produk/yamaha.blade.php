...
<body>
    ...
    <section class="hero-section" id="home"
        style="background: url('{{ Vite::asset('resources/images/yamaha.jpg') }}') no-repeat center center; background-size: cover; padding: 120px 0; position: relative;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-6 text-white">
                    <h1 class="display-4 fw-bold mb-4">Yamaha</h1>
                    <p class="lead mb-4">
                        Motor Yamaha menawarkan performa bertenaga dengan desain sporty dan teknologi modern. Dikenal

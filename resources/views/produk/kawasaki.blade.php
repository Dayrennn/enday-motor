...
<body>
    ...
    <section class="hero-section" id="home"
        style="background: url('{{ Vite::asset('resources/images/kawasaki.jpg') }}') no-repeat center center; background-size: cover; padding: 120px 0; position: relative;">
        ...
        <div class="container" style="position: relative; z-index: 2;">
            <div class="row align-items-center">
                <div class="col-lg-6 text-white">
                    <h1 class="display-4 fw-bold mb-4">Kawasaki</h1>
                    <p class="lead mb-4">
                        Kawasaki dikenal dengan performa tinggi dan desain agresif. Dibuat untuk pengendara yang
                        menginginkan kecepatan, kekuatan, dan pengalaman berkendara yang lebih sporty. Cocok untuk gaya
                        dan adrenalin di jalanan. Motor Yamaha menawarkan performa bertenaga dengan desain sporty dan
                        teknologi modern. Dikenal
                        responsif dan stabil, Yamaha menjadi pilihan bagi pengendara yang mengutamakan gaya, kecepatan,
    ...
    <section id="products" class="py-5">
        <div class="container">
            ...
            <div class="row">
                <!-- mengambil data yang telah disimpan di $motors -->

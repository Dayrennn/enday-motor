...
<head>
    ...
    <title>Data Contact Sales - Penjualan Motor</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="sidebar-menu">
                    ...
                    <a href="{{ route('sales.contact') }}" class="active">
                                        ...
                                        @foreach ($contacts as $contact)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form
                                                        action="{{ route('sales.contact.updateStatus', $contact->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
    ...
    @foreach ($contacts as $contact)
        ...
        <div class="modal fade" id="modalHapusContact{{ $contact->id }}" tabindex="-1"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <form action="{{ route('sales.contact.destroy', $contact->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">

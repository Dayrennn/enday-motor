...
<head>
    ...
    <title>Dashboard Sales - Penjualan Motor</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                ...
                <div class="sidebar-menu">
                    <a href="{{ route('sales.dashboard') }}" class="active">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="card-value">{{ $totalPenjualanFormatted }}</div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="card-value">{{ $totalUnitTerjual }}</div>
                    ...
                    <div class="col-md-3">
                        <div class="card stat-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="card-title">Jumlah Pelanggan</h6>
                                        <div class="card-value">{{ $jumlahPelanggan }}</div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="card-value">{{ $pesanMasuk }}</div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="chart-container">
                            <h5 class="fw-bold mb-4">Statistik Penjualan 6 Bulan Terakhir</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="chart-container">
                            <h5 class="fw-bold mb-4">Card 1</h5>
